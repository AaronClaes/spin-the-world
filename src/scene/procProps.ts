...
//
// Each record gets one, and it's always the piece the island is composed
// around — the thing that makes the world worth watching turn. The harbour's
// lighthouse sweeps a beam; the city's sign flickers. Neither is something a
// downloaded mesh can do, and building them here also means their lit parts
// can be bright enough for the bloom pass to catch and sized for a prop that
// renders about 60px tall, rather than inherited from whatever a source model
// happened to use.
//
